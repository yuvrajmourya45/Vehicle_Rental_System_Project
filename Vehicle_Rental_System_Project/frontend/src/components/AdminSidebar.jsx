...
export default function AdminSidebar() {
  ...
  return (
    <>
      <button onClick={() => setIsOpen(!isOpen)} className="md:hidden fixed top-4 left-4 z-50 p-2 bg-blue-600 text-white rounded-lg">
      ...
      <div className={`w-56 bg-white h-screen shadow-lg fixed left-0 top-0 z-40 transition-transform flex flex-col ${
        ...
        <nav className="p-3 flex-1 overflow-y-auto">
          <Link to="/" className="flex items-center gap-2 px-3 py-2.5 rounded-lg mb-3 bg-blue-50 text-blue-600 hover:bg-blue-100 transition text-sm border border-blue-200">
            <Home size={18} />
